  ...
  const renderEmptyView = () => (
    <div className="products-empty">
      <h2 className="products-empty-heading">
        {search === '' ? 'No dishes listed yet' : 'No dishes match that search'}
      </h2>
      <p className="products-empty-text">
        {search === ''
          ? 'Dishes you add will appear here and in the live restaurant menu for customers to order.'
  ...
  const renderDeleteConfirm = () => (
    <div className="delete-overlay">
      <div className="delete-dialog">
        <h2 className="delete-dialog-heading">Delete this dish?</h2>
        <p className="delete-dialog-text">
          <span className="delete-dialog-title">{productToDelete.title}</span>{' '}
          will be removed from the menu. This cannot be undone — but it stays
