...
const categoryOptions = [
  ...
  {
    name: 'Chinese / Fastfood',
    categoryId: 'Chinese / Fastfood',
  },
  {
    name: 'Biryani',
    categoryId: 'Biryani',
  ...
  {
    name: 'Chat Bandi',
    categoryId: 'Chat Bandi',
  },
  {
    name: 'Juice Center',
    categoryId: 'Juice Center',
  },
  {
  ...
  const renderProductsList = () => {
    ...
    return shouldShowProductsList ? (
      ...
      <div className="no-products-view">
        <img
          src="/no-food-found.svg"
          className="no-products-img"
          alt="no dishes found"
        />
        <h1 className="no-products-heading">No Dishes Found</h1>
        <p className="no-products-description">
          We could not find any dishes matching your selection. Try exploring another category or clearing filters.
        </p>
      </div>
    )
  }
